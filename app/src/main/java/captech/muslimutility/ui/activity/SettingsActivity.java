        ...
        public void praying(String key, Object value) {
            switch (key) {
                ...
                case "mazhab":
                    ...
                    editor.putString("mazhabvalue", String.valueOf(value));
                    editor.apply();
                    editor.commit();
                    ConfigPreferences.setLocationConfig(getActivity(), new LocationInfo(locationInfo.latitude
                            , locationInfo.longitude, locationInfo.name, locationInfo.name_english
                            ...
                            , locationInfo.dls, locationInfo.timeZone, locationInfo.city_ar));
                    if (String.valueOf(value).equals("2")) {
                        PrayingFragment.c5.setVisibility(View.GONE);
                        PrayingFragment.c6.setVisibility(View.GONE);
                    } else {
                        PrayingFragment.c5.setVisibility(View.VISIBLE);
                        PrayingFragment.c6.setVisibility(View.VISIBLE);
                    }
                    break;
